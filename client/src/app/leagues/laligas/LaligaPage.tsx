...
import laligaPage from "../../../assets/images/leagues/laliga/laligaPage.jpg";
        ...
        <div className="h-screen w-full flex flex-row bg-black overflow-hidden">
            ...
            <div className="flex flex-col h-full flex-1 min-w-0">
                <div
                    ...
                    style={{
                        backgroundImage: `url(${laligaPage})`,
                    ...
                    >
                        <div className="absolute inset-0 flex flex-col items-center justify-center z-30 pointer-events-none">
                            <div className="pointer-events-auto flex flex-col items-center">
                                ...
                                <p className="mt-5 text-2xl md:text-3xl text-white tracking-[20px] md:tracking-[70px] text-center">
                                    Tournament
                                </p>
                            </div>
                        </div>
